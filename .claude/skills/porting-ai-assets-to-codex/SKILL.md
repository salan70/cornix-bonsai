...
rg -n 'ask_user_input|Task tool|Claude Code|\.agents/skills.*symlink|正本は `.claude`' templates/ai-driven-development/.agents templates/ai-driven-development/AGENTS.md
```
